...
export default function Lunch() {
    ...
    const fetchLunchRecipes = async () => {
        try {
            ...
            console.log('Fetched lunch recipes:', data) // Debug log
    ...
    const renderView = ({ item, index }) => {
        return (
            <View style={styles.card}>
                <TouchableOpacity onPress={() => router.push(`/recipe/lunch/${item._id}`)}>
                    <Image 
    ...
    if (loading) {
        return (
            <View style={{ backgroundColor: "indigo", flex: 1, justifyContent: 'center', alignItems: 'center' }}>
                <Text style={{ color: 'white', fontSize: 18 }}>Loading lunch recipes...</Text>
            </View>
        )
    }
    ...
    if (error) {
        return (
            <View style={{ backgroundColor: "indigo", flex: 1, justifyContent: 'center', alignItems: 'center' }}>
                ...
                <TouchableOpacity onPress={fetchLunchRecipes} style={styles.retryButton}>
